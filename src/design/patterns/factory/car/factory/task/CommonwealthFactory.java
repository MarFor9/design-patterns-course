...
public class CommonwealthFactory implements Factory{
    ...
    public Car buildBMW(BMWModel model) {
        switch (model) {
            case X5:
                return new BMW(100, "Disel", 2022, WheelSide.LEFT);
            case E60:
                return new BMW(120, "GAS", 2021, WheelSide.LEFT);
            default:
    ...
    public Car buildFord(FordModel model) {
        switch (model) {
            case CMAX:
                return new Ford(100, "Disel", 2022, WheelSide.LEFT);
            case FOCUS:
                return new Ford(120, "GAS", 2021, WheelSide.LEFT);
            default:
                throw new IllegalArgumentException("Unknown model");
        }
    }
